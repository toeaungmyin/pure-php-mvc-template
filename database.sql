-- Database schema compatible with MySQL, PostgreSQL, and SQLite
-- This file contains the basic schema that works across all supported databases
...
-- Notes: 
-- For PostgreSQL, change AUTO_INCREMENT to SERIAL
-- For SQLite, change AUTO_INCREMENT to AUTOINCREMENT
-- The timestamp syntax may need adjustment for different databases 